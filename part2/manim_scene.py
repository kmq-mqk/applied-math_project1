...
class S01_Title(Scene):
    def construct(self):
        title = Text("Visualization of\nMatrix Decomposition and\nDiagonalization",
                     font_size=52, color=YELLOW,
                     line_spacing=1.3).move_to(ORIGIN)
        self.play(Write(title), run_time=2)
        self.wait(0.5)
        self.play(title.animate.to_edge(UP).scale(0.6))
        grp_name = Text("Nhóm 10", color=PINK, font_size=30).next_to(title, DOWN, buff=1)
        members_name = Text(
                       "Khúc Minh Quân         \n"
        ...
        members_mssv = Text(
                        ...
                        "- 24120218"
                        ,font_size=20)
        grp_members = VGroup(members_name, members_mssv).arrange(RIGHT, buff=0.5).next_to(grp_name, DOWN, buff=0.5)
        self.play(FadeIn(grp_name), FadeIn(grp_members))
        self.wait(2)
        self.play(FadeOut(grp_name), FadeOut(grp_members))
...
class S04_SVD_Transform(Scene):
    def construct(self):
        ...
        self.play(FadeIn(disk), FadeIn(grid), GrowArrow(arr_e1), GrowArrow(arr_e2))
        self.wait(0.5)
        ...
        self.play(
            Write(step1_title),
            Transform(crn, crn_vtz),

            Transform(disk, disk2),
            Transform(grid, grid2),
            Transform(arr_e1, arr1_e1),
            Transform(arr_e2, arr1_e2),
            run_time=2)
        ...
        self.play(
            ...
            Transform(disk, disk3),
            Transform(grid, grid3),
            Transform(arr_e1, arr2_e1),
            Transform(arr_e2, arr2_e2),
            run_time=2)
        self.wait(0.7)
...
class S06_Eigen(Scene):
    def construct(self):
        ...
        self.play(Write(gen_eq), run_time=1.8)
        self.wait(1)
        ...
        self.play(FadeIn(mat_var), run_time=2)
        self.wait(1)
        ...
        self.play(Transform(mat_var, mat_num), run_time=1.8)
        self.wait(1)

        poly = MathTex(
            rf"({a11:.0f} - \lambda)({a22:.0f} - \lambda) - ({a12:.0f} \cdot {a21:.0f}) = 0",
            font_size=36, color=YELLOW
        ).next_to(mat_var, DOWN, buff=1)
        ...
        self.play(Create(line_main), run_time=0.5)
        self.play(Create(line_sub), run_time=1)
#        self.play(Create(line_main), Create(line_sub), run_time=2)
        self.wait(1)
        ...
        self.play(Write(lam1_tex), Write(lam2_tex), run_time=1)
        self.wait(0.6)
        ...
        self.play(FadeIn(vec1_tex, shift=LEFT*0.2), FadeIn(vec2_tex, shift=LEFT*0.2), run_time=2)
        self.wait(1)
        ...
        self.play(GrowArrow(a1), GrowArrow(a2), Write(l1), Write(l2), run_time=1.5)
        self.wait(2)
        self.play(*[FadeOut(m) for m in self.mobjects])
...
class S07_Diag_Build(Scene):
    def construct(self):
        ...
        self.play(FadeIn(grp_eq_exp_P), run_time=2)
        self.wait(0.5)
        ...
        self.play(
            P_block.animate.move_to(grp_P_Pinv[0].get_center()),
...
class S08_Diag_D(Scene):
    def construct(self):
        heading = Text("Calculate matrix D", font_size=38, color=YELLOW).to_edge(UP)
        self.play(Write(heading))
        ...
        self.play(Write(eq1.next_to(heading, DOWN, buff=1)), run_time=1.5)
        self.wait(0.8)
        ...
        self.play(Write(equals), FadeIn(D_val, shift=LEFT*0.2), run_time=2)
        self.wait(1.5)
        self.play(*[FadeOut(m) for m in self.mobjects])
...
class S09_Diag_Final(Scene):
    def construct(self):
        ...
        self.play(Write(eq_sym), Create(box), run_time=2)
        self.wait(1)
        ...
        self.play(FadeIn(full, shift=UP*0.3), run_time=2)
        self.wait(0.5)
...
class S10_End(Scene):
    def construct(self):
        ...
        sub    = Text("- Nhóm 10", font_size=30, color=GRAY)\
                     .next_to(thanks, DOWN + RIGHT*0.1, buff=0.5)
